...
const OurTeam = () => {
    return (
        <section className="bg-[#272727] rounded-t-[2rem] pt-10 text-white ">
            {/* New Content Section */}
            <div className="mt-16 text-center mx-auto">
                ...
                <div className='md:px-20 px-10'>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between w-full m-auto overflow-hidden h-auto gap-6">
                ...
                <div className='px-10 md:px-20 '>
                    <div className="mt-5 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] shadow-[#313338] bg-[#222222] relative flex justify-between md:flex-row py-5 lg:h-[300px] rounded-3xl overflow-hidden border border-gray-700 text-center items-center">
                        <img
                        ...
                        <div className="md:w-[50%] flex-1 float-right lg:ml-[100px] w-full h-full justify-center text-start flex flex-col gap-4 px-4 md:px-10">
                            <h4 className=" text-xl md:text-5xl font-SpaceGrotesk font-bold">We’re not just teaching Arabic</h4>
            ...
            <div className=" bg-[#8262b0] mt-10 md:mt-[150px] w-full md:py-8 flex justify-around items-center gap-4">
                {['YAMANI', 'EGYPTIAN', 'LEBANESE', 'EMARATI'].map((dialect, index) => (
                    <div
                        key={dialect}
                        className="font-medium flex items-center h-full text-white border-b-2 border-transparent hover:border-purple-600 cursor-pointer"
                    >
                        <h1 className="text-center Melodrama mx-3 text-lg md:text-5xl">
                            {dialect}
                        </h1>
                        {index === 3 ? "" : <img src="/images/icon102.png" alt="" width={35} height={35} className='lg:ml-20 md:ml-10 my-2 w-[20px] h-[15px] lg:h-[35px] lg:w-[35px]' />}
                    </div>
                ))}
            </div>
