...
const HeroSection = () => {
  return (
    <section className="text-center flex flex-col md:pt-10 px-10 items-center justify-between md:space-y-8 ">
      {/* Heading */}
      ...
      <h1 className="text-3xl md:text-6xl text-[#4e4e4e] Melodrama">
        one
        <span className="text-white ml-5 text-2xl md:text-5xl bg-[#8262b0] font-SpaceGrotesk font-[500] px-2 py-1 md:px-8 rounded-lg">
          Arabic
        </span>
        <span className="text-white font-SpaceGrotesk font-[500] ml-5 text-2xl md:text-5xl bg-[#8262b0] px-2 py-1 md:px-8 rounded-lg">
          dialect
        </span>
      </h1>
