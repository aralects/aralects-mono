...
const FAQs = () => {
  ...
  return (
    <section className="bg-white text-gray-900 px-10 md:px-20 py-12">
      {/* FAQ Header */}
      ...
      {/* FAQ Items */}
      <div className="grid grid-cols-1 max-h-[500px] overflow-y-auto mt-10 md:grid-cols-2 gap-y-6 mx-auto">
        {faqs.map((faq, index) => (
          <div
            key={index}
