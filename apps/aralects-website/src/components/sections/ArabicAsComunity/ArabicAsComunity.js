...
function ArabicAsComunity() {
    return (
        <div className="w-full h-fit lg:px-[5.5rem] px-10 md:px-20 py-16 mx-auto flex flex-col md:flex-row justify-between relative">
            {/* Background Image */}
            <img
                src="/images/ArabicAsComunityBg.jpg"
                alt=""
                className="absolute h-full w-full bottom-0 left-0 -z-10 object-cover top-0"
            />
