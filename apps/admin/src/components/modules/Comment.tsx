    ...
    <Card className="w-full max-w-2xl bg-zinc-950 text-white">
      ...
      <CardContent className="space-y-4 p-4">
        <div className="rounded-lg bg-zinc-900 p-4">
          <p>
            Great use of metaphors to show the character&apos;s conflict. A bit
            more background might help clarify their motivations. Well done
            overall!
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex items-center space-x-4">
          ...
          <div className="relative flex-1">
            <Textarea
              ...
              className="h-10 min-h-0 resize-none border-zinc-800 bg-zinc-900 py-2 text-white"
            />
            <Button
              type="submit"
              size="icon"
