...
const WhyAralects = () => {
  return (
    <section className="bg-[#272727] w-full mt-10 text-white pb-20 rounded-[2rem] lg:px-5 m-auto">
      {/* Header Section */}
      <img
      ...
      <div className="text-start mt-10 flex flex-col md:flex-row px-10 md:px-20  w-full justify-between items-center gap-8">
        <div className="md:w-[45%]">
          <h2 className="text-4xl mb-10 font-SpaceGrotesk font-bold">
            Why Aralects?
          </h2>
          ...
          <p className="mt-4 md:text-[1.2rem] font-SpaceGrotesk text-gray-300 max-w-2xl">
            Most apps focus on rigid lessons and miss the immersive,
            life-scenario conversations that bring Arabic to life.
          </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 px-10 md:px-20 w-full gap-5 mx-auto">
        {[
          ...
          >
            <span class="w-[300px] h-[300px] rounded z-10 bg-[#a07ed1] absolute -top-[300px] right-0 translate-x-full ease-out duration-300 transition-all mb-9 ml-9 md:group-hover:mr-0 md:group-hover:mb-32 group-hover:translate-x-0 group-hover:translate-y-full"></span>
            ...
            <img
              ...
              height={30}
            />
            <h3 className="text-xl w-[90%] z-20 sm:text-2xl mt-5 font-SpaceGrotesk font-semibold">
              {feature}
            </h3>
          </div>
        ))}
