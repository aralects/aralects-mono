...
const FAQs = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Lorem ipsum dolor sit amet consectetur. Eget interdum eget morbi nec morbi lorem. Et cursus erat eget euismod faucibus. Mauris pellentesque id amet blandit vulputate vitae lectus. Accumsan proin at nunc ornare id auctor aliquam.",
    },
    {
  ...
  return (
    <section className="bg-white w-full text-gray-900 px-5 relative md:px-20 py-12">
      ...
      <div className="text-start">
        <h2 className="text-3xl md:text-4xl text-gray-700 font-SpaceGrotesk font-bold">
          FAQs
        </h2>
      </div>
      ...
      <div className="grid grid-cols-1 max-h-[500px] overflow-y-auto mt-10 md:grid-cols-2 gap-y-6">
        {faqs.map((faq, index) => (
          <div key={index} className="border-b w-[90%] border-gray-300 pb-4">
            <div
