    ...
    return (
        <div className={classes.overlay}>
            <div className={classes.popup}>
                ...
                <div className={secondBtnApear ? classes.secondPart : bothBtns ? classes.secondPartheight : classes.secondPart}>
                    <span className={classes.titleStyle}>{text1}</span>
                    <span className={classes.subtitle}>{text2}</span>

                    {bothBtns ? (
                        <>
                            <button className={classes.btnStyle + " " + classes.secondStyle} onClick={onSecondaryClick || onClose}>
                                {btnText2}
                            </button>
                            <button className={classes.btnStyle} onClick={onPrimaryClick || onClose}>
                                {btnText}
                            </button>
                        </>
                    ) : secondBtnApear ? (
